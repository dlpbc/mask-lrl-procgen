...
class MaskMonobeast(Monobeast):
    ...
    def setup(self, model_flags, observation_space, action_spaces, policy_class):
        ...
        model = policy_class(observation_space, action_spaces, model_flags.num_tasks, model_flags.use_lstm) 
        ...
        learner_model = policy_class(
            observation_space, action_spaces, model_flags.num_tasks, model_flags.use_lstm
